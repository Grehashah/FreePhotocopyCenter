  ...
  else
  {
              ...
              if(in_array($fileActualExt, $allowed))
              {
                if($fileError === 0)
                {
                  ...
                  $fileDestination="img/user-photos/advertiser/".$fileNameNew;
                  $fileDestination1="../admin/img/user-photos/advertiser/".$fileNameNew;
              ...
              if($fileNameNew != "")
              {                    
            $str4="update advertiser set AUname='$uname1', APwd='$pwd1', AFname='$fname1', ALname='$lname1', Gender='$gender1',Pic='$fileNameNew' , DOB='$dob1', ContactNo='$cno1', Email='$email1',OfficeName='$officename1', Address='$address1', AreaId='$areaid' where AdvId='$aid' ";
            ...
            else
            {
             ...
             $str4="update advertiser set AUname='$uname1', APwd='$pwd1', AFname='$fname1', ALname='$lname1', Gender='$gender1',Pic='$pic' , DOB='$dob1', ContactNo='$cno1', Email='$email1',OfficeName='$officename1', Address='$address1', AreaId='$areaid' where AdvId='$aid' ";
              $conn4=mysqli_connect("localhost","root","","freephotocopycenter");
              $result4=$conn4->query($str4);
                       echo "<script>location.href='profile.php'</script>";
              }
...
<section class="wrapper site-min-height">
        ...
        <div class="chat-room mt">
          <aside class="mid-side">
            ...
            <div>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="img/user-photos/advertiser/<?php echo "$pic"; ?>" class="img-square" width="100"> 
          </div>
            <br>
            <div class="group-rom">
            ...
            <div class="group-rom">
              ...
              <div class="second-part"><input type='text' name='txtgender' size='50' value='<?php  echo $gender; ?>' onkeypress="return charactersonly();">
            ...
            <div class="group-rom">
              ...
              <div class="second-part"><textarea name='txtaddress' rows='5'  maxlength='300' cols='52'><?php  echo $address; ?></textarea></div>
            </div>
            <div class="group-rom">
            ...
            <div class="group-rom">
                    <div class="first-part"><b>Office Area : </b></div>
                      <div class="second-part">
                        <input type='text' name='txtofficearea' value='<?php  echo $a; ?>' onkeypress="return charactersonly();" disabled><br><br>
                        <select name="cmbarea">   
