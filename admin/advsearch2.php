...
<section class="wrapper site-min-height">
  <form name='frm' method='post' action='goldexport.php'>
...
{
$id=$_POST["txtsuname"];
$str="select * from advertiseradvertise,advertiser where advertiseradvertise.AdvId=advertiser.AdvId and AdtypeId=2 and AUname like '$id%'"; 
}
else
{
