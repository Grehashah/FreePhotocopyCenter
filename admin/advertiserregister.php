...
if(isset($_POST["btnsubmit"]))
{
  ...
  $auname=$_POST["txtusername"];
  $afname=$_POST["txtfirstname"];
  $alname=$_POST["txtlastname"];
 ...
 //validations
  ...
  else if(empty($officename))
  {
      $onameerr="Must be filled.";
  }
...
//unique id and email required
        ...
        $stradmin="select * from admin where AdminUname='$auname'";
        $strmember="select * from member where MUname='$auname'";
        $strxeroxshop="select * from xeroxshop where XUname='$auname'";
        $stradvertiser="select * from advertiser where AUname='$auname'";
...
if($flag==0)
{
                  ...
                  $no++;
                    $fileNameNew = "adv".mt_rand(100000,999999).".".$fileActualExt;
                    $fileDestination="../advertiser/img/user-photos/advertiser/".$fileNameNew;
                        $fileDestination1="img/user-photos/advertiser/".$fileNameNew;
                
                    move_uploaded_file($fileTmpName, $fileDestination);
                     copy($fileDestination,$fileDestination1);

                     $str="insert into advertiser values('','$auname','$apwd','$afname','$alname','$gender','$fileNameNew','$doj','$dob','$contactno','$email','$lastseen','$isauth','$officename','$address','$areaid')";
...
<section class="wrapper">       
   <div class="col-lg-10">
                   ...
                   <h3>&nbsp;&nbsp;<i class="fa fa-angle-right"></i> <b>Registration Form For Advertiser</b></h3> <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" method="post" action="" enctype="multipart/form-data">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="firstname" name="txtfirstname" type="text" value="<?php echo $afname; ?>" onkeypress="return charactersonly();" maxlength='20'>  <font color="red"><?php echo $fnameerr; ?></font>
                 ...
                 <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="lastname" name="txtlastname" type="text" value="<?php echo $alname; ?>" onkeypress="return charactersonly();" maxlength='20'>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="username" name="txtusername" type="text" value="<?php echo $auname; ?>" maxlength='20'>  <font color="red"><?php echo $unameerr; ?></font>
                  ...
                  <div class="form-group ">
                    ...
                    <input type="radio" value="female" name="rdbgender" <?php echo $r2; ?>> Female </input>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="password" name="txtpassword" type="password" value="<?php echo $apwd; ?>" maxlength='8'>  <font color="red"><?php echo $pwderr; echo $pwderr1; ?></font>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="confirm_password" name="txtconfirm_password" type="password" value="<?php echo $confirmpwd; ?>" maxlength='8'>  <font color="red"><?php echo $cpwderr; echo $cpwderr1; ?></font>
              ...
              <div class="form-group">
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class="form-control " id="contactno" name="txtcontactno" type="text" value="<?php echo $contactno; ?>" onkeypress="return numsonly();" maxlength='10'>         <font color="red"><?php echo $cnoerr; echo $cnoerr1; ?></font>
                  ...
                  <div class="form-group ">
                    <label for="officename" class="control-label col-lg-2"><font size='3'>Office Name <sup><font color='red'>*</font></sup> :</font></label>
                    <div class="col-lg-10">
                      <input class="form-control " id="officename" name="txtofficename" type="text" value="<?php echo $officename; ?>" maxlength='20'><font color="red"><?php echo $onameerr; ?></font>
                    </div>
                  </div>
                  ...
                  <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <textarea class="form-control " id="address" name="txtaddress" rows="10" cols="10" maxlength="300"><?php echo $address; ?></textarea>   <font color="red"><?php echo $addresserr; ?></font>
           ...
           <div class="form-group">
                  ...
                  <div class="col-lg-10">
                    <form method="post" enctype="multipart/form-date" style='margin-top: 6px;'>
