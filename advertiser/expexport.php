...
$str1.="<tr><td>". 1 . "</td><td>". 'January' ."</td><td>". $amt1 ."</td></tr>";
$str1.="<tr><td>". 2 . "</td><td>". 'February' ."</td><td>". $amt2 ."</td></tr>";
$str1.="<tr><td>". 3 . "</td><td>". 'March' ."</td><td>". $amt3 ."</td></tr>";
$str1.="<tr><td>". 4 . "</td><td>". 'April' ."</td><td>". $amt4 ."</td></tr>";
$str1.="<tr><td>". 5 . "</td><td>". 'May' ."</td><td>". $amt5 ."</td></tr>";
$str1.="<tr><td>". 6 . "</td><td>". 'June' ."</td><td>". $amt6 ."</td></tr>";
$str1.="<tr><td>". 7 . "</td><td>". 'July' ."</td><td>". $amt7 ."</td></tr>";
$str1.="<tr><td>". 8 . "</td><td>". 'August' ."</td><td>". $amt8 ."</td></tr>";
$str1.="<tr><td>". 9 . "</td><td>". 'September' ."</td><td>". $amt9 ."</td></tr>";
$str1.="<tr><td>". 10 . "</td><td>". 'Octaber' ."</td><td>". $amt10 ."</td></tr>";
$str1.="<tr><td>". 11 . "</td><td>". 'November' ."</td><td>". $amt11 ."</td></tr>";
$str1.="<tr><td>". 12 . "</td><td>". 'December' ."</td><td>". $amt12 ."</td></tr>";
