...
<section class="wrapper site-min-height">
 <form name='frm' method='post' action='silverexport.php'>
  
  <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <font size="5">&nbsp;<i class="fa fa-angle-right"></i> <b>Records of Advertiser</b> </font><p class="nav pull-right top-menu"><button class='btn btn-round btn-success' name='btnexport' type='submit'>Export to Excel&nbsp;&nbsp;<img src='img/icons/excel.png' height='25' width='25'></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p><hr>
            </form>
...
{
$id=$_POST["txtsuname"];
$str="select * from advertiseradvertise,advertiser where advertiseradvertise.AdvId=advertiser.AdvId and AdtypeId=1 and AUname like '$id%'"; 
}
else
{
