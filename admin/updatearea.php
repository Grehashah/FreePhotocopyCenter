...
$anameerr="";
  ...
  $str1="select AreaName from area where AreaID='$aid'";
...
if(isset($_POST["btnsubmit"]))
{
  ...
  {
	$str="update area set AreaName='$aname' where AreaId='$aid'";
...
<div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> <b>Update Area</b></h4>
              ...
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" name="frm1" method="post" action="">
                 ...
                 <div class="form-group ">
                    <label for="areaid" class="control-label col-lg-2">Area Id<font color='red'><sup>*</sup></font> :</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="areaid" name="txtaid" type="text" value="<?php echo $aid ?>" onkeypress="return numsonly();">
                          <font size='2' color="red"><?php echo $aerr; ?></font>
                 ...
                 <div class="form-group ">
                    ...
                    <div class="col-lg-10">
                      <input class=" form-control" id="areaname" name="txtaname" type="text" value="<?php echo $aname ?>" onkeypress="return charactersonly();">    <font size='2' color="red"><?php echo $anameerr; ?></font>
