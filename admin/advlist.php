...
<section class="wrapper site-min-height">
  ...
  <form name='frm' method='post' action='advexport.php'>
 <div class="row">
          <div class="col-md-12">
            <div class="content-panel">
              <font size="5">&nbsp;<i class="fa fa-angle-right"></i> <b>Records of Advertisers</b> </font><p class="nav pull-right top-menu"><button class='btn btn-round btn-success' name='btnexport' type='submit'>Export to Excel&nbsp;&nbsp;<img src='img/icons/excel.png' height='25' width='25'></button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p></form><hr>
...
{
$id=$_POST["txtsuname"];
$str="select * from advertiser where auname like '$id%'"; 
}
else
{
...
{
  $str1.="<tr><td>".$no."</td><td>".$row["AUname"]."</td><td>".$row["OfficeName"]."</td><td>".$row["DOJ"]."</td><td>".$row["ContactNo"]."</td><td>".$row["Lseen"]."</td><td>".$row["IsAuth"]."</td><td><a href='advprofile.php?ID=".$row["AdvId"]."'class='btn btn-round btn-primary'>View</a></td></tr>";
  $no++;
}
