...
if(isset($_POST["btnsubmit"]))
{
  ...
  {
    $str="insert into college values('','$cname')";
...
<div class="col-lg-12">
            <h4><i class="fa fa-angle-right"></i> <b>Insert College</b></h4>
            <div class="form-panel">
              <div class="form">
                <form class="cmxform form-horizontal style-form" id="signupForm" name="frm1" method="post" action="">

                 <div class="form-group ">
                    <label for="areaname" class="control-label col-lg-2">College Name<font color='red'><sup>*</sup></font> :</label>
                    <div class="col-lg-10">
                      <input class=" form-control" id="areaname" onkeypress="return charactersonly();" name="txtcname" type="text" value="<?php echo $cname ?>" placeholder="Enter College Name">
